...
export default async function DashboardPage() {
  return (
    <PageContainer>
      ...
      <ContentGrid className="sm:grid-cols-2 lg:grid-cols-2">
        <Link
          href="/dashboard/tanks"
          className="group block h-full transition-colors focus:outline-none focus:ring-2 focus:ring-aqua-blue/35"
        >
          <Card className="h-full border-aqua-deep/10 transition-colors group-hover:border-aqua-blue/40">
            <h2 className="text-sm font-semibold text-aqua-deep">Becken verwalten</h2>
        ...
        <Link
          ...
          className="group block h-full transition-colors focus:outline-none focus:ring-2 focus:ring-aqua-blue/35"
        >
          <Card className="h-full border-aqua-blue/35 bg-aqua-soft transition-colors group-hover:border-aqua-blue">
            <h2 className="text-sm font-semibold text-aqua-deep">Diagnose starten</h2>
      ...
      <Card as="section" aria-label="Kurzüberblick">
